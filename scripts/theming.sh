...
if [ "KDE" == "${XDG_CURRENT_DESKTOP}" ]; then
    ...
    xfconf-query -c xfce4-desktop -p /backdrop/screen0/monitorePD1/workspace0/last-image \
    ...
    xfconf-query -c xfce4-panel --create -p /plugins/plugin-3/show-labels --set false
else
