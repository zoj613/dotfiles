...
dotarray=(
    .config .i3 .profile .bash_aliases .bash_profile .bash_functions
    .bash_fzf .bash_powerline .bash_pyenv .dmenurc .bashrc .gitconfig
    .vimrc .inputrc .Xresources .fehbg .xinitrc .gtkrc-2.0.mine
)
